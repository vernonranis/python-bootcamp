...
def calculator():
    ...
    keep_looping = input(f"Type 'y' to continue calculating with {first_answer}, or type 'n' to start a new calculation: ")
    if keep_looping == "y":
        continue_operation = True
        system("clear")
        print(logo)
    ...
    while continue_operation == True:
        ...
        calculation_function = operation[operation_symbol]
        keep_looping = input(f"Type 'y' to continue calculating with {second_answer}, or type 'n' to start a new calculation: ")
        if keep_looping == "y":
            continue_operation = True
        elif keep_looping == "n":
            continue_operation = False
